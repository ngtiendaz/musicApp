...
public class Form_Library extends javax.swing.JPanel {

    public Form_Library() {
        initComponents();
        ImageIcon imageIcon = new ImageIcon("D:\\Data_Music\\Ảnh\\qr.jpg");
        Image image = imageIcon.getImage(); // Lấy đối tượng Image từ ImageIcon
        Image scaledImage = image.getScaledInstance(100, 100, Image.SCALE_SMOOTH);
        imageIcon = new ImageIcon(scaledImage);
        qr.setIcon(imageIcon);
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gradient = new GradientPaint(0, 0, Color.decode("#3a6186"), getWidth(), getHeight(), Color.decode("#89253e"));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nghe không giới hạn. Dùng");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("thử 2 tháng Premium với giá ₫59.000.");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Chỉ ₫59.000/tháng sau đó. Hủy bất kỳ lúc nào.");
        ...
        jLabel5.setText("59.000 ₫ trong 2 tháng, sau đó là 59.000 ₫ mỗi tháng. Ưu đãi chỉ áp dụng nếu bạn chưa từng dùng thử Premium. Có áp dụng điều khoản.");
