...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("homez", "Home", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("find", "Search ", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("favorite", "Favorite Songs", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("artistnew", "Artists Following", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("user2", "Profile", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("", "Load", Model_Menu.MenuType.TITLE));

        listMenu1.addItem(new Model_Menu("add", "Upload", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("libraryMusic", "Library", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        listMenu1 = new com.mycompany.musicapp.component.ListMenu<>();
    ...
    private com.mycompany.musicapp.component.ListMenu<String> listMenu1;
