...
import com.mycompany.musicapp.component.item.ItemArtist_Ngang;
...
public class ListArtist_Ngang<E extends Object> extends JList<E> {

    private final DefaultListModel model;
    private int playIndex = -1;

    public ListArtist_Ngang() {
...
//                    System.out.println("Rendering Artist: " + data.getName());
                ...
                ItemArtist_Ngang item = new ItemArtist_Ngang(data);
                return item;
            }
        };
    }
