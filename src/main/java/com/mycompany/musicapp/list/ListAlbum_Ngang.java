...
import com.mycompany.musicapp.item.ItemAlbum_Ngang;
...
public class ListAlbum_Ngang<E extends Object> extends JList<E> {

    private final DefaultListModel model;
    private int playIndex = -1;

    public ListAlbum_Ngang() {
...
//                    System.out.println("Rendering Album: " + data.getTitleAlbum());
                ...
                ItemAlbum_Ngang item = new ItemAlbum_Ngang(data);
                return item;
            }
        };
    }
